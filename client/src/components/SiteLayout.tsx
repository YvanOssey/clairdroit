    ...
    <footer className="mt-24 bg-[#12243b] text-[#f7f4ee]">
      <div className="container grid gap-12 py-14 md:grid-cols-[1.2fr_0.8fr_1fr] md:gap-16">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm text-[#dfe3e7]">
            <Link href="/mentions-legales" className="transition-colors hover:text-[#d7a187]">Mentions légales</Link>
            <Link href="/politique-confidentialite" className="transition-colors hover:text-[#d7a187]">Politique de confidentialité</Link>
          </div>
        </div>
        <div>
