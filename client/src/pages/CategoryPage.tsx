    ...
    <PageShell>
      <section className="border-b border-[rgba(18,36,59,0.14)] bg-[#ece6da]">
        <div className="container grid gap-10 py-16 md:grid-cols-[1fr_300px] md:items-end md:py-24">
          <div><div className="mb-7 flex items-center gap-3"><span className="h-px w-12 bg-[#b86e4b]" /><span className="eyebrow">Rubrique · {categoryName}</span></div><h1 className="font-display text-6xl font-semibold leading-[0.84] tracking-[-0.055em] md:text-8xl">Le droit<br /><em className="font-normal text-[#b86e4b]">en pratique.</em></h1></div>
          <div className="border-l border-[#b86e4b] pl-5"><p className="font-display text-2xl leading-[1.15] text-[#12243b]">Une entrée pour regarder ce domaine sans le réduire à une suite de définitions.</p><p className="mt-5 text-sm leading-6 text-[#536174]">{categoryArticles.length} publication{categoryArticles.length > 1 ? "s" : ""} actuellement visible{categoryArticles.length > 1 ? "s" : ""}.</p></div>
        </div>
      </section>
