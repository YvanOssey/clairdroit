...
export function LegalNotice() {
  return <PageShell><LegalHeader eyebrow="Informations du site" title="Mentions légales" intro="Les informations d’identification et de contact de ClairDroit, blog personnel consacré à la compréhension du droit." /><div className="container max-w-4xl space-y-12 py-14 md:py-20">
...
export function PrivacyPolicy() {
  return <PageShell><LegalHeader eyebrow="Données et confidentialité" title="Politique de confidentialité" intro="Cette page explique, dans une première version, quelles données sont recueillies par ClairDroit et pourquoi elles sont utilisées." /><div className="container max-w-4xl space-y-12 py-14 md:py-20">
