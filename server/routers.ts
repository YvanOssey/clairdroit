...
const siteSettingsInput = z.object({
  ...
  pageContent: z.object({
    about: z.object({
      ...
      intentionEyebrow: z.string().trim().min(1).max(180),
      intentionTitleMain: z.string().trim().min(1).max(180),
      intentionTitleAccent: z.string().trim().min(1).max(180),
      paragraphOne: z.string().trim().min(1).max(5000),
      paragraphTwo: z.string().trim().min(1).max(5000),
      biography: z.string().trim().min(1).max(20000),
      quote: z.string().trim().min(1).max(500),
      quoteAttribution: z.string().trim().min(1).max(180),
      principlesEyebrow: z.string().trim().min(1).max(180),
      principleOneTitle: z.string().trim().min(1).max(120),
      principleOneBody: z.string().trim().min(1).max(1000),
      principleTwoTitle: z.string().trim().min(1).max(120),
      principleTwoBody: z.string().trim().min(1).max(1000),
      principleThreeTitle: z.string().trim().min(1).max(120),
      principleThreeBody: z.string().trim().min(1).max(1000),
      ctaEyebrow: z.string().trim().min(1).max(180),
    ...
    decryptions: z.object({
      ...
      titleAccent: z.string().trim().min(1).max(180),
      description: z.string().trim().min(1).max(1000),
      filterEyebrow: z.string().trim().min(1).max(180),
      emptyEyebrow: z.string().trim().min(1).max(180),
      emptyTitle: z.string().trim().min(1).max(300),
      emptyDescription: z.string().trim().min(1).max(1000),
    }),
    rubrics: z.object({
      ...
      titleAccent: z.string().trim().min(1).max(180),
      intro: z.string().trim().min(1).max(1000),
      selectionEyebrow: z.string().trim().min(1).max(180),
      selectionTitle: z.string().trim().min(1).max(180),
      emptyEyebrow: z.string().trim().min(1).max(180),
      emptyTitle: z.string().trim().min(1).max(300),
    }),
    contact: z.object({
      ...
      detailsEyebrow: z.string().trim().min(1).max(180),
      email: z.string().trim().email().max(180),
      responseNote: z.string().trim().min(1).max(300),
      location: z.string().trim().min(1).max(180),
      locationNote: z.string().trim().min(1).max(300),
      disclaimer: z.string().trim().min(1).max(1000),
      aboutLinkLabel: z.string().trim().min(1).max(180),
    }),
    legalNotice: z.object({
      eyebrow: z.string().trim().min(1).max(180),
      title: z.string().trim().min(1).max(180),
      intro: z.string().trim().min(1).max(1500),
      editorTitle: z.string().trim().min(1).max(180),
      editorBody: z.string().trim().min(1).max(5000),
      activityTitle: z.string().trim().min(1).max(180),
      activityBody: z.string().trim().min(1).max(5000),
      hostingTitle: z.string().trim().min(1).max(180),
      hostingBody: z.string().trim().min(1).max(5000),
      rightsTitle: z.string().trim().min(1).max(180),
      rightsBody: z.string().trim().min(1).max(5000),
      contactTitle: z.string().trim().min(1).max(180),
      contactBody: z.string().trim().min(1).max(5000),
      draftNotice: z.string().trim().min(1).max(1500),
    }),
    privacyPolicy: z.object({
      eyebrow: z.string().trim().min(1).max(180),
      title: z.string().trim().min(1).max(180),
      intro: z.string().trim().min(1).max(1500),
      controllerTitle: z.string().trim().min(1).max(180),
      controllerBody: z.string().trim().min(1).max(5000),
      dataTitle: z.string().trim().min(1).max(180),
      dataBody: z.string().trim().min(1).max(5000),
      purposesTitle: z.string().trim().min(1).max(180),
      purposesBody: z.string().trim().min(1).max(5000),
      retentionTitle: z.string().trim().min(1).max(180),
      retentionBody: z.string().trim().min(1).max(5000),
      requestsTitle: z.string().trim().min(1).max(180),
      requestsBody: z.string().trim().min(1).max(5000),
      cookiesTitle: z.string().trim().min(1).max(180),
      cookiesBody: z.string().trim().min(1).max(5000),
      draftNotice: z.string().trim().min(1).max(1500),
    }),
  }),
});
...
async function notifyWithoutBlocking(
  payload: Parameters<typeof sendNotificationEmail>[0]
) {
  try {
...
async function resolveLogoUrl(req: {
  protocol?: string;
...
export const appRouter = router({
    ...
    login: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const token = await sdk.signSession({
          openId,
          appId: ENV.appId || "blog-juridique",
  ...
  site: router({
    ...
    updateSettings: adminProcedure
      ...
      .mutation(({ input }) => upsertSiteSettings(input)),
  }),
  contact: router({
    submit: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (isHoneypotFilled(input.website))
          return { success: true, id: undefined } as const;
  ...
  articles: router({
    ...
    update: adminProcedure
      .input(articleInput.extend({ id: z.number().int().positive() }))
    ...
    trash: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        if (existing.status === "trashed")
          throw new TRPCError({
            code: "BAD_REQUEST",
            message: "Cet article est déjà dans la corbeille.",
          });
    ...
    restore: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        if (existing.status !== "trashed")
          throw new TRPCError({
            code: "BAD_REQUEST",
            message: "Seul un article dans la corbeille peut être restauré.",
          });
    ...
    purge: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        if (existing.status !== "trashed")
          throw new TRPCError({
            code: "BAD_REQUEST",
            message: "Déplacez d’abord l’article dans la corbeille.",
          });
