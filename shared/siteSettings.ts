...
export const SITE_SETTINGS_DEFAULTS: SiteSettingsValues = {
  ...
  rubrics: {
    ...
    contact: {
      ...
      description: "Vous souhaitez proposer un angle, signaler une précision ou parler d’un partenariat éditorial ? La boîte aux lettres de ClairDroit est ouverte.",
    ...
    legalNotice: {
      ...
      intro: "Les informations d’identification et de contact de ClairDroit, blog personnel consacré à la compréhension du droit.",
      editorTitle: "Éditeur du site",
      editorBody: "Le site ClairDroit est un blog personnel édité par Corinne Thio. Lieu d’établissement déclaré : Cocody · Abidjan · Côte d’Ivoire. Adresse de contact : corinnethio52@gmail.com.",
      activityTitle: "Activité du site",
      activityBody: "ClairDroit propose des articles d’actualité juridique, des articles vulgarisés, des analyses juridiques et des conseils liés aux carrières juridiques. Les contenus ont une vocation informative et pédagogique et ne constituent pas un avis juridique personnalisé.",
      hostingTitle: "Hébergement",
      hostingBody: "Les informations relatives à l’hébergeur et aux modalités techniques d’hébergement seront complétées avant la mise en ligne définitive du site.",
      rightsTitle: "Propriété intellectuelle",
      rightsBody: "Sauf mention contraire, les textes, éléments graphiques, logo et contenus originaux de ClairDroit sont protégés par les règles applicables à la propriété intellectuelle. Toute reproduction substantielle doit faire l’objet d’une autorisation préalable.",
      contactTitle: "Contact",
      contactBody: "Pour signaler une erreur, demander une précision ou poser une question concernant le site, écrivez à corinnethio52@gmail.com.",
      draftNotice: "Document de travail : ces informations doivent être relues et adaptées avant une utilisation définitive.",
    },
    privacyPolicy: {
      eyebrow: "Données et confidentialité",
      title: "Politique de confidentialité",
      intro: "Cette page explique quelles données sont recueillies par ClairDroit et pourquoi elles sont utilisées.",
      controllerTitle: "Responsable du traitement",
      controllerBody: "Les traitements liés au site sont réalisés sous la responsabilité de Corinne Thio, à Cocody · Abidjan · Côte d’Ivoire. Adresse de contact : corinnethio52@gmail.com.",
      dataTitle: "Données recueillies",
      dataBody: "Le formulaire Nous écrire peut recueillir votre nom, votre adresse email, l’objet et le contenu de votre message. La newsletter enregistre l’adresse email nécessaire à l’envoi des actualités.",
      purposesTitle: "Finalités",
      purposesBody: "Ces données sont utilisées pour répondre aux messages reçus, gérer les inscriptions à la newsletter, assurer la sécurité du panneau d’administration et améliorer le fonctionnement éditorial du site.",
      retentionTitle: "Conservation et destinataires",
      retentionBody: "Les données sont conservées pendant la durée nécessaire à leur traitement et peuvent être transmises aux prestataires techniques strictement nécessaires à l’hébergement, au stockage et à l’envoi des notifications email. Les durées précises devront être confirmées dans la version définitive.",
      requestsTitle: "Vos demandes",
      requestsBody: "Pour demander une correction, une suppression ou une information sur vos données, écrivez à corinnethio52@gmail.com en précisant l’objet de votre demande.",
      cookiesTitle: "Cookies et mesure d’audience",
      cookiesBody: "Le site peut utiliser des cookies techniques nécessaires à la session d’administration. Tout service tiers supplémentaire devra être décrit ici avant son activation publique.",
      draftNotice: "Document de travail : ces informations doivent être relues et adaptées avant une utilisation définitive.",
    },
  },
};
